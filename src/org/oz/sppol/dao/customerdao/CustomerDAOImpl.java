...
public class CustomerDAOImpl  extends  JdbcDaoSupport implements CustomerDAO {
    ...
    private static final String GET_CUSTOMER_ID= "SELECT CUSTOMER_ID,FIRST_NAME,LAST_NAME,CUSTOMER_NUMBER,DISPLAY_NAME,CUSTOMER_CATEGORY  FROM SLS_CUSTOMER WHERE   ACTIVE_STATUS='Y' AND CUSTOMER_ID = ?";
...
*/
    ...
    public boolean insertCustomerDetail(CustomerDTO customerDTO) {
        ...
        Object[] params = { CUSTOMER_ID1,
                ...
                customerDTO.getdisplayName(),
                customerDTO.getcustomerCategory(),""};
        int[] types  ={Types.INTEGER,Types.VARCHAR,Types.VARCHAR,Types.INTEGER,Types.VARCHAR,Types.VARCHAR,Types.VARCHAR};
